...
> Hiệp hội Meeds có quyền thay đổi công thức nếu cần thiết – ví dụ như trường hợp xuất hiện sử dụng cụ thể gì đó. The association can also blacklist any Hub that hijacks the formula to its unique benefit.
