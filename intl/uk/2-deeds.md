...
Неможливий маркер (NFT) є унікальним токеном, який відображає гарно. У горі - смерть використовується як власник. Кожен вид дає власнику право на доступ до деяких послуг - наприклад, доступ до цифрової служби, що працює на програмного забезпечення Meeds і право видобувати Meeds.

WM вітає всілякі організації - DAO, традиційні корпорації, об'єднання, аналітичні центри, партнерства, театральні компанії, групи проектів, школи тощо. Ненарод представляє їх цифрове існування у Гор.

## 2.2. Пропозиція добин

WoM в кінцевому підсумку забезпечить обмежену кількість депозитів. Кожна деталь включає в себе попередньо визначену максимальну кількість користувачів і пропонує ємність винагород Meeds (Винахідна сила). Термін "користувач" тут і тут: він визначає будь-який тип працівника, працівника, фрілансера, волонтера і т.д.
...
У «ХМ» справи будуть поступово генеруватися всередині віртуальних міст. З самого початку буде існувати лише перше місто. Інші будуватимуться поступово, по одному. У всій Горе завжди буде лише 7 міст, кожна з яких містить фіксовану кількість подат кожного типу.

Коли всі справи будуть обрані, місто буде вже вивчене. Потім, видобування нового міста почнеться на $2^n$ місяців після останнього відділу міста $n-1$.
