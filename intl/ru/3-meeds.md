...
The WoM is powered by its currency – the Meeds (MEED) token. Meeds используются для вознаграждения пользователей (через программы вовлечения), покупки в магазинах, приобретения Deeds, получения финансовых доходов от инвестиций и т.д.
...
5 Million Meeds (5% of the total supply) were pre-minted initially. Из них 4,5 млн. заблокированы в контракте хранилища с линейным размещением на протяжении 4 лет. The pre-minted amount was mainly used to acquire software IP, pay for token emission’s legal fees, and host services.
