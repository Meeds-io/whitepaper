...
Рабочая Метавселенная функционирует на своей валюте - токене Meeds (MEED). Meeds используются для вознаграждения пользователей (через программы вовлечения), покупки в магазинах, приобретения Deeds, получения финансовых доходов от инвестиций и т.д.
