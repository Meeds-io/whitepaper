...
# 2. لا مفتاح XPath: / h1 الملف: 2-deeds.md الأعمال NFT - منظمات ميتافرس العمل (Deeds NFT - Work Metaverse Organizations)
...
- ** تنويهات ** - يمكن للمستخدمين منح الشهرة لبعضهم البعض ، كشكر وتقدير. طلب السياق نظرًا لأن االكيدوسات المتاحة للتوزيع محدودة (حد دوري محدد مسبقًا ، 3 في الأسبوع على سبيل المثال) ، فهي نادرة وقيمة. مثل الأفعال، يحمل الكودوس نقاط. وبهذه الطريقة يمكن للموظفين أن يكافئوا زملائهم.
...
- ** Wallet ** - يتم تزويد المستخدمين بمحفظة تقنية Ethereum آمنة لتخزين معداتهم. طلب السياق. وبدلاً من ذلك ، بالنسبة للمستخدمين المتقدمين ، يمكن استخدام محفظة Metamask.
...
| 3: Ashtarte   | 10000       | Reshef + 8 months    | 6 000      | 3 000         | 995       | 5          |
