...
Οι χρήστες στον κοινοτικό κόμβο τους μπορούν να κερδίζουν Εμβλήματα και Πιστοποιητικά όταν συμμετέχουν. Θα τους αφήσουμε να τα αποθηκεύσουν και σε ένα πορτοφόλι ή να τα κατεβάσετε ως επαληθεύσιμα διαπιστευτήρια [^7][^8]. Αυτά τα διαπιστευτήρια αποτελούν απόδειξη της γνώσης / τεχνογνωσίας που πιστοποιείται από τον οργανισμό έκδοσης.
...
**Badges** Τα εμβλήματα αντιπροσωπεύουν επιτεύγματα που έγιναν μέσα σε μια κοινότητα. Μετά την ολοκλήρωση ενός συνόλου στόχων ή προκλήσεων, οι χρήστες κερδίζουν πόντους. Μπορούν να κερδίσουν εμβλήματα αναγνώρισης, καθώς συσσωρεύουν πόντους και να φτάσουν ορισμένα όρια.
