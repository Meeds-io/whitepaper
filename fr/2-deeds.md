...
Pour commencer, les services suivants sont fournis par l'association Meeds gratuitement et peuvent être utilisés immédiatement pour récompenser l'engagement :
- Moteur de Gamification – des actions utilisateur détectées automatiquement au sein du WoM ont une valeur en points, qui peut être ajusté aux priorités du Deed via des programmes d’engagement personnalisables.
- Challenges – Des défis personnalisables peuvent être mis en place pour représenter des accomplissements significatifs difficilement détectables automatiquement. Les challenges sont prédéfinis par une personne et peuvent être relevés et déclarés comme réussis par une autre. Les challenges ont aussi une valeur en points, dans le cadre de programmes d’engagement personnalisables.
- Programmes d'engagement - les organisations peuvent créer leurs propres programmes d'engagement en accord avec à leurs objectifs et priorités d'entreprise par exemple. Les programmes regroupent des actions automatiques et des challenges déclarés manuellement. Chaque programme a un budget défini en Meeds. Les points gagnés périodiquement par chaque utilisateur dans chaque programme d'engagement sont convertis en Meeds, selon le budget de ce programme.
